...
def resolutionSinSubestimacion(problem):
    return tree_search(problem, RamaAcotacion())


def resolutionConSubestimacion(problem):
    return tree_search(problem, RamaAcotacionSubestimacion(problem))
